...
<body>
    ...
    <div class="profilim-icon" onclick="window.location.href='profilimakademisyen.php'">
    ...
    <div id="menu" class="menu">
        ...
        <a href="akademisyen_not_girisi.php">Not Gir</a>
    ...
    <div class="announcement-container">
        <div class="announcement">
            <h5>Duyuru 1</h5>
            <p>Bu alanda duyuru içeriği gösterilecek.</p>
        </div>
        <div class="announcement">
            <h5>Duyuru 2</h5>
            <p>Bu alanda duyuru içeriği gösterilecek.</p>
